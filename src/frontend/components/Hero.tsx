...
export default function Hero() {
  ...
  const handleConfirmRole = () => {
    if (selectedRole) {
      // Redirect ke dashboard - user akan diarahkan ke proses registrasi di Header
      window.location.href = "/dashboard";
    }
  };
  ...
  const roles = [
    ...
    },
    {
      ...
      description:
        "Creator of Beauty - Seniman yang memiliki kreativitas tak terbatas dan kemampuan ekspresi visual.",
    },
    {
      id: "traveler",
      name: "Traveler",
      ...
      description:
        "Explorer of New Horizons - Petualang yang selalu mencari pengalaman baru dan perspektif berbeda.",
    },
    {
      id: "literature",
      name: "Literature",
      ...
      description:
        "Master of Words - Ahli komunikasi yang dapat menyampaikan ide-ide kompleks dengan cara yang mudah dipahami.",
    },
  ];
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/20 p-20 rounded-2xl border border-black backdrop-blur-sm">
            ...
            <p className="text-xl text-gray-800 mb-6 max-w-3xl mx-auto leading-relaxed font-minecraft">
              Jelajahi dunia fantasi yang penuh petualangan, tantangan, dan
              misteri. Pilih peranmu, kembangkan karaktermu, dan buktikan bahwa
              kamu adalah pahlawan sejati dalam game RPG terbaik.
            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 px-4 pt-4 max-w-2xl mx-auto">
                  {roles.map((role) => (
                    ...
                    >
                      ...
                      <h3
                        className={`text-lg font-semibold text-center transition-colors mb-3 font-minecraft ${
                          selectedRole === role.id
