...
export default function CharacterInfo({
  ...
  // 🔑 Urutkan role sesuai urutan fix
  ...
  return (
    <div>
      ...
      {isSubmitting && (
        <p className="text-center text-gray-500">Mengganti role...</p>
      )}
      ...
      <div className="flex items-start space-x-6 mb-6">
        ...
        <div className="flex-1 space-y-3">
          {orderedRoles.map((role) => {
            const { percentage, expInCurrentLevel, expForNextLevel } =
              getExpDetails(role.level, role.exp);
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <h4
                      className={`font-semibold font-minecraft ${
                        role.is_active ? "text-orange-700" : "text-gray-900"
                      }`}
                    >
                      {role.role_name}{" "}
                      {role.is_active && (
