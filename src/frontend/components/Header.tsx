...
export default function Header() {
  ...
  // --- Data Role dengan badge seperti Hero ---
  const roles = [
    {
      id: "codes",
      name: "Codes",
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <span className="text-xl font-bold text-gray-900 font-minecraft">
              Habits Quest 4 Life
            </span>
            ...
            <div className="flex items-center space-x-4">
              {isLoading ? (
                ...
                <button
                  onClick={handleLogin}
                  disabled={isLoading}
                  className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-medium px-6 py-2 rounded-lg"
                >
                  Start
                </button>
              )}
      ...
      {/* Modal Registrasi (sama gaya Hero) */}
      {showModal && (
